...
# Configuration
BIOSTUDIES_API_URL = "https://ftp.ebi.ac.uk/biostudies/fire/"  # Replace with actual source
...
async def get_data_by_accession(accession_code: str):
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            response = await client.get(f"{BIOSTUDIES_API_URL}{accession_folder}/{accession_number}/{accession_code}/{accession_code}.json")
